 ...
 */
public class AppDescriptionPersistence extends SelfDescriptionPersistenceAdapter {

    private final Logger logger = LoggerFactory.getLogger(AppDescriptionPersistence.class);
    ...
    static String rewriteResource(String currentString, AppResource resource, URI catalogUri) throws URISyntaxException {
...
//        (((AppRepresentation) infrastructureComponent).)
