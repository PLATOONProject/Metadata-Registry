...
public interface AppStatusHandler {
     ...
     * @param dataApp The new / updated dataapp which was announced to the broker
     ...
     */
    URI updated(AppResource dataApp, URI connectorUri) throws IOException, RejectMessageException;
