...
public class AppConfig extends AppConfigTemplate {
    ...
    public MultipartComponentInteractor build() {
        ...
        AppMessageHandler appHandler = new AppMessageHandler(appPersistence, selfDescriptionProvider.getSelfDescription(), securityTokenProvider, repositoryFacade, responseSenderAgent);
        ...
        component.addMessageHandler(appHandler, RequestType.INFRASTRUCTURE);
